...
const LARGE_DEVELOPERS: ReadonlyArray<DeveloperEntry> = [
  ...
  { canonical: 'Atlus', aliases: ['atlus', 'アトラス', 'atlus co'] },
  { canonical: 'Koei Tecmo', aliases: ['koei tecmo', 'koei tecmo games', 'koei', 'tecmo', 'コーエーテクモゲームス', 'コーエーテクモ'] },
  { canonical: 'Level-5', aliases: ['level-5', 'level 5', 'level5', 'レベルファイブ'] },
  { canonical: 'miHoYo', aliases: ['mihoyo', 'hoyoverse', 'cognosphere', 'mihayo'] },
  { canonical: 'NetEase', aliases: ['netease', 'netease games'] },
  { canonical: 'Tencent', aliases: ['tencent', 'tencent games'] },
  { canonical: 'Ubisoft', aliases: ['ubisoft', 'ubisoft montreal', 'ubisoft quebec', 'ubisoft toronto', 'ubisoft paris', 'ubisoft annecy', 'ubisoft bordeaux', 'ubisoft reflections', 'ubisoft red storm', 'ubisoft singapore'] },
  ...
  { canonical: 'EA', aliases: ['electronic arts', 'ea games', 'ea sports'] },
...
const MAJOR_PUBLISHER_SUBSIDIARIES: ReadonlyArray<DeveloperEntry> = [
  ...
  { canonical: 'Tango Gameworks', aliases: ['tango gameworks', 'tango'] },
  ...
  { canonical: 'Raven Software', aliases: ['raven software', 'raven'] },
  ...
  { canonical: '2K Games', aliases: ['2k games', '2k', '2k boston', '2k czech'] },
  // SEGA
  ...
  { canonical: 'Relic Entertainment', aliases: ['relic entertainment', 'relic'] },
  { canonical: 'Amplitude Studios', aliases: ['amplitude studios', 'amplitude'] },
